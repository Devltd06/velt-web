...
See docs/AI_QUICKSTART.md for a minimal developer quickstart that demonstrates a server-side OpenAI proxy and a small ChatGPT-style UI (app/aisearch.tsx).
